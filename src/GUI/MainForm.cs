...
namespace Draw
{
    ...
    public partial class MainForm : Form
    {
        ...
        {
            dialogProcessor.AddShape3();

            statusBar.Items[0].Text = "Последно действие: Рисуване на фигура 3";
        ...
        {
            dialogProcessor.AddShape0();

            statusBar.Items[0].Text = "Последно действие: Рисуване на фигура 0";
        ...
        //    //statusBar.Items[0].Text = "Последно действие: Рисуване на Shape8";
